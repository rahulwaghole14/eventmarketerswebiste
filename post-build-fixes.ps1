# Post-build script - run this automatically after Next.js build
# Add this to your package.json scripts:
# "build": "npm run build && powershell -ExecutionPolicy Bypass -File post-build-fixes.ps1"

param(
    [string]$BuildDir = "out"
)

Write-Host "Applying post-build fixes for image loading..."
...
foreach ($category in $categories) {
    $file = "$BuildDir\category\$category\index.html"
...
Write-Host "Post-build fixes completed!"
