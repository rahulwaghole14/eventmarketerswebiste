...
export default function Footer() {
  return (
    <footer className="relative bg-gray-900/50 backdrop-blur-xl border-t border-white/10">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 mx-auto max-w-7xl pl-6 sm:pl-8 md:pl-12 pr-4 sm:pr-6 py-6 sm:py-8">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-5 lg:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl sm:text-2xl font-bold text-white">MarketBrand.ai</span>
            </div>
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base md:text-lg">
              Create stunning marketing materials for your business in minutes. 
              Professional templates, easy customization, instant download.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/marketbrand.ai/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:glass-hover transition-all duration-300 group" aria-label="Follow us on Instagram">
              ...
              <a href="https://www.facebook.com/people/MarketBrand-AI/61583921555346/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:glass-hover transition-all duration-300 group" aria-label="Follow us on Facebook">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://wa.me/918551941415" target="_blank" rel="noopener noreferrer" className="w-12 h-12 glass rounded-2xl flex items-center justify-center hover:glass-hover transition-all duration-300 group" aria-label="Contact us on WhatsApp">
                <svg className="w-5 h-5 text-gray-300 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div className="border-t border-white/10 mt-6 sm:mt-8 pt-4 sm:pt-5">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 sm:space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 md:space-x-8 text-sm sm:text-base md:text-lg text-gray-400">
              <span className="flex items-center space-x-2">
                <span>Made by RSL Solution</span>
              </span>
              <div className="flex items-center space-x-2 glass px-3 sm:px-4 py-1.5 sm:py-2 rounded-full">
                <span>🌍</span>
                <span>English</span>
              </div>
            </div>
