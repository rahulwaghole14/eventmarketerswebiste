          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-16">
            ...
            <div className="space-y-4 sm:space-y-5 md:space-y-6">
                ...
                <div className="inline-flex flex-wrap items-center gap-2 px-3 sm:px-4 md:px-6 py-2 sm:py-3 rounded-full glass animate-shimmer max-w-full">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-white whitespace-nowrap">Live Now - <CountUp end={10000} suffix="+ Users" className="inline-block" /></span>
                ...
                <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-400 leading-relaxed font-light break-words">
                  ...
                  Download our app, choose from 10,000+ ready-made templates, and boost your business today.
                </p>
              </div>
              ...
              <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 space-y-2.5 sm:space-y-3 md:space-y-4 w-full">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm text-gray-400">
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    ...
                    <span className="whitespace-nowrap">10,000+ Templates</span>
                  </div>
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    <svg className="w-3 h-3 sm:w-4 sm:h-4 text-green-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd"/>
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="card-premium group text-center space-y-4 sm:space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg px-3 sm:px-4 py-2">
                <Link href="/templates" className="text-purple-300 font-semibold hover:text-white transition-colors flex items-center justify-center gap-1 text-xs sm:text-sm break-words"><FaPalette className="inline flex-shrink-0" /> <span className="text-center">10,000+ Professional Templates Available</span></Link>
              </div>
              <div className="flex justify-center">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 sm:gap-10 md:gap-12">
            ...
            <div className="text-center space-y-4 sm:space-y-6">
              ...
              <p className="text-gray-300 text-sm sm:text-base md:text-lg leading-relaxed break-words px-2">
                Browse 10,000+ professional templates. Select from business categories, 
                festivals, or general marketing materials.
              </p>
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg px-3 sm:px-4 py-2">
                <Link href="/templates" className="text-purple-300 font-semibold hover:text-white transition-colors flex items-center justify-center gap-1 text-xs sm:text-sm break-words"><FaPalette className="inline flex-shrink-0" /> <span className="text-center">10,000+ Templates • All Business Types</span></Link>
              </div>
            </div>
            ...
            <div className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-6 lg:p-8 hover:border-white/20 transition-all duration-300 hover:shadow-2xl hover:shadow-yellow-500/10">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Our Pro plan is just ₹599 per quarterly, which is significantly less than hiring a designer. 
                    This includes access to 10,000+ templates, unlimited downloads, and premium customization features.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-4xl px-6 md:px-8 lg:px-12 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <a 
              ...
              className="card-premium text-center space-y-4 group cursor-pointer hover:scale-105 transition-all duration-300"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                  <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white group-hover:gradient-text transition-all duration-300">Email Support</h3>
              <p className="text-gray-300 group-hover:text-white transition-colors">support@marketbrand.ai</p>
            </a>
            
            <a 
              href="https://wa.me/918551941415" 
              target="_blank" 
              rel="noopener noreferrer"
              className="card-premium text-center space-y-4 group cursor-pointer hover:scale-105 transition-all duration-300"
            >
              ...
              <h3 className="text-xl font-bold text-white group-hover:gradient-text transition-all duration-300">Live Chat</h3>
              <p className="text-gray-300 group-hover:text-white transition-colors">Available 24/7 in app</p>
            </a>
            ...
            <Link 
              ...
              className="card-premium text-center space-y-4 group cursor-pointer hover:scale-105 transition-all duration-300"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-orange-500 rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300">
                <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd"/>
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white group-hover:gradient-text transition-all duration-300">Help Center</h3>
              <p className="text-gray-300 group-hover:text-white transition-colors">Browse our knowledge base</p>
            </Link>
          </div>
        </div>
      </div>
