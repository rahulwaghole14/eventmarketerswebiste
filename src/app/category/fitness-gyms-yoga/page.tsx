  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="relative py-24 bg-gradient-to-br from-green-500/20 via-teal-500/20 to-blue-500/20 overflow-hidden">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full px-4 py-2">
                  <span className="text-green-300 text-sm font-semibold">✓ Trusted by 3,500+ Fitness Professionals</span>
                </div>
                <div className="bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-full px-4 py-2">
                  <span className="text-blue-300 text-sm font-semibold">⭐ 4.8/5 Rating</span>
                </div>
                <div className="bg-gradient-to-r from-teal-500/20 to-green-500/20 border border-teal-500/30 rounded-full px-4 py-2">
                  <span className="text-teal-300 text-sm font-semibold">🚀 1-Minute Download</span>
                </div>
              </div>

              <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-teal-500 rounded-3xl flex items-center justify-center mx-auto mb-8 text-5xl shadow-2xl animate-pulse">
                💪
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Fitness Professionals</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Fitness Templates</div>
                </div>
                <div className="text-center">
