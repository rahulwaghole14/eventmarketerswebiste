...
import { FaRocket, FaBolt, FaPalette, FaPlug } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Generator Rental Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional generator rental and power backup service marketing materials. Download ready-made templates for generator services, power backup rental, event generator services. Boost generator business with MarketBrand.ai",
  keywords: "generator marketing, generator rental marketing, power backup marketing, event generator marketing, generator service templates",
  alternates: { canonical: "/category/generator" },
  openGraph: {
    title: "Generator Rental Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional generator rental and power backup service marketing materials. Download ready-made templates for generator services, power backup rental, event generator services.",
    url: "https://www.marketbrand.ai/category/generator",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-generator.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
export default function GeneratorPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Generator Rental Marketing Materials & Promotional Content",
    "description": "Professional generator rental and power backup service marketing materials for generator service professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited generator rental marketing materials"
    },
    "category": "Generator Rental Marketing Services"
  };
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Generator</span>
            </nav>
          </div>
        </div>

        {/* Enhanced Hero Section */}
        <div className="relative py-16 overflow-hidden bg-gradient-to-br from-gray-500/20 via-slate-500/20 to-zinc-500/20">
