...
import { FaRocket, FaBolt, FaPalette, FaVolumeUp } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Sound System Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional sound system rental and audio equipment marketing materials. Download ready-made templates for sound services, DJ equipment, event sound systems. Boost sound business with MarketBrand.ai",
  keywords: "sound system marketing, sound rental marketing, audio equipment marketing, DJ sound marketing, event sound system templates",
  alternates: { canonical: "/category/sound" },
  openGraph: {
    title: "Sound System Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional sound system rental and audio equipment marketing materials. Download ready-made templates for sound services, DJ equipment, event sound systems.",
    url: "https://www.marketbrand.ai/category/sound",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-sound.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
export default function SoundPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Sound System Marketing Materials & Promotional Content",
    "description": "Professional sound system rental and audio equipment marketing materials for sound service professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited sound system marketing materials"
    },
    "category": "Sound System Marketing Services"
  };
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Sound</span>
            </nav>
          </div>
        </div>
