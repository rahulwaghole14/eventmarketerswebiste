...
import { FaRocket, FaBolt, FaPalette, FaBuilding } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Banquet Hall Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional banquet hall promotional videos, marketing posters & business materials. Download ready-made templates for banquet halls, wedding venues, event venues. Boost banquet hall business with MarketBrand.ai",
  keywords: "banquet hall marketing, banquet hall promotional videos, wedding venue marketing, event venue marketing, banquet hall templates",
  alternates: { canonical: "/category/banquet-hall" },
  openGraph: {
    title: "Banquet Hall Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional banquet hall promotional videos, marketing posters & business materials. Download ready-made templates for banquet halls, wedding venues, event venues.",
    url: "https://www.marketbrand.ai/category/banquet-hall",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-banquet-hall.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
export default function BanquetHallPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Banquet Hall Marketing Materials & Promotional Content",
    "description": "Professional banquet hall promotional videos, marketing posters & business materials for banquet hall and venue professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited banquet hall marketing materials"
    },
    "category": "Banquet Hall Marketing Services"
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Banquet Hall</span>
            </nav>
          </div>
        </div>
        ...
        {/* Final CTA Section */}
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 relative overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 lg:px-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center">
              <Link 
                href="/download"
                className="inline-flex items-center justify-center px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl sm:rounded-2xl text-white font-bold text-lg sm:text-xl md:text-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
