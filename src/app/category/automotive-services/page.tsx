  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="relative py-16 bg-gradient-to-br from-gray-500/20 via-gray-600/20 to-gray-700/20 overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 md:px-8 lg:px-12">
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
              ...
              <div className="flex flex-row lg:flex-col gap-2 justify-center lg:justify-start lg:sticky lg:top-24">
                <div className="bg-gradient-to-r from-gray-500/20 to-gray-600/20 border border-gray-500/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-gray-300 text-xs font-semibold whitespace-nowrap">✓ Trusted by 2,500+ Automotive Professionals</span>
                </div>
                <div className="bg-gradient-to-r from-gray-600/20 to-gray-700/20 border border-gray-600/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-gray-300 text-xs font-semibold whitespace-nowrap">⭐ 4.6/5 Rating</span>
                </div>
                <div className="bg-gradient-to-r from-gray-700/20 to-gray-800/20 border border-gray-700/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-gray-300 text-xs font-semibold whitespace-nowrap">🚀 1-Minute Download</span>
                </div>
              </div>
            </div>
          </div>
