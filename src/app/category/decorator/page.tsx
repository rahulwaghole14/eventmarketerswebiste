...
export const metadata: Metadata = {
  title: "Decorator Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional event decoration and design service marketing materials. Download ready-made templates for decorator services, event decoration, wedding decoration. Boost decorator business with MarketBrand.ai",
  keywords: "decorator marketing, event decoration marketing, wedding decorator marketing, decoration service templates, event decor marketing",
  alternates: { canonical: "/category/decorator" },
  openGraph: {
    title: "Decorator Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional event decoration and design service marketing materials. Download ready-made templates for decorator services, event decoration, wedding decoration.",
    url: "https://www.marketbrand.ai/category/decorator",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-decorator.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
export default function DecoratorPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Decorator Marketing Materials & Promotional Content",
    "description": "Professional event decoration and design service marketing materials for decorator professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited decorator marketing materials"
    },
    "category": "Event Decoration Marketing Services"
  };
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Decorator</span>
            </nav>
          </div>
        </div>
