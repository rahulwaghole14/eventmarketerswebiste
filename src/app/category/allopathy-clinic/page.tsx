...
import { FaRocket, FaBolt, FaPalette, FaHospital } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Allopathy Clinic Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional allopathy clinic promotional videos, marketing posters & business materials. Download ready-made templates for allopathy clinics, general medicine practices, modern healthcare services.",
  keywords: "allopathy clinic marketing, general medicine promotional videos, allopathy practice marketing, modern healthcare marketing, allopathy clinic templates",
  alternates: { canonical: "/category/allopathy-clinic" },
};

export default function AllopathyClinicPage() {
  return (
      ...
      <div className="bg-gray-800/50 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
          <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-white font-semibold break-words">Allopathy Clinic</span>
          </nav>
        </div>
      </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black gradient-text mb-4 leading-[1.2] sm:leading-[1.3]">Allopathy Clinic Templates</h1>
            </div>
          ...
          <div className="relative mt-0">
            <HorizontalImageCarousel 
              images={[
                "/Medical & Diagnostics/Allopathy Clinic/1.png",
                "/Medical & Diagnostics/Allopathy Clinic/2.png",
                "/Medical & Diagnostics/Allopathy Clinic/3.png",
                "/Medical & Diagnostics/Allopathy Clinic/4.png",
                "/Medical & Diagnostics/Allopathy Clinic/5.png"
              ]}
              interval={2000}
            />
          </div>
      ...
      <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="card-premium text-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto text-3xl">
                💼
              </div>
      ...
      <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-blue-500/20 via-indigo-500/20 to-purple-500/20 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 lg:px-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black gradient-text mb-4 sm:mb-6">
            Create Allopathy Clinic Materials
          </h2>
