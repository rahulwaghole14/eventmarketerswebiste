...
import { FaRocket, FaBolt, FaPalette, FaLeaf } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Ayurveda Clinic Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional ayurveda clinic promotional videos, marketing posters & business materials. Download ready-made templates for ayurveda clinics, ayurvedic treatments, wellness services.",
  keywords: "ayurveda clinic marketing, ayurvedic promotional videos, ayurveda practice marketing, wellness marketing, ayurveda clinic templates",
  alternates: { canonical: "/category/ayurveda-clinic" },
};
...
export default function AyurvedaClinicPage() {
  return (
    <div className="min-h-screen bg-gray-900">
      <div className="bg-gray-800/50 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
          <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
            ...
            <span className="text-gray-500">/</span>
            <span className="text-white font-semibold break-words">Ayurveda Clinic</span>
          </nav>
        </div>
      </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black gradient-text mb-4 leading-[1.2] sm:leading-[1.3]">Ayurveda Clinic Templates</h1>
            </div>
          ...
          <div className="relative mt-0">
            <HorizontalImageCarousel 
              images={[
                "/Medical & Diagnostics/Ayurveda Clinic/1.png",
                "/Medical & Diagnostics/Ayurveda Clinic/2.png",
                "/Medical & Diagnostics/Ayurveda Clinic/3.png",
                "/Medical & Diagnostics/Ayurveda Clinic/4.png",
                "/Medical & Diagnostics/Ayurveda Clinic/5.png"
              ]}
              interval={2000}
            />
          </div>
      ...
      <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="card-premium text-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto">
            ...
            <div className="card-premium text-center space-y-6">
              <div className="w-20 h-20 bg-gradient-to-r from-teal-500 to-green-500 rounded-2xl flex items-center justify-center mx-auto text-3xl">
                💼
              </div>
      ...
      {/* Final CTA Section */}
      <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-green-500/20 via-emerald-500/20 to-teal-500/20 relative overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-10 right-10 w-72 h-72 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-10 left-10 w-80 h-80 bg-gradient-to-r from-emerald-500/10 to-teal-500/10 rounded-full blur-3xl animate-float-slow"></div>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 lg:px-12 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black gradient-text mb-4 sm:mb-6">
            Create Ayurveda Clinic Materials
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center">
            <Link 
              href="/download"
              className="inline-flex items-center justify-center px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl sm:rounded-2xl text-white font-bold text-lg sm:text-xl md:text-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
            >
