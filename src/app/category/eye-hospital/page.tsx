...
import { FaRocket, FaBolt, FaPalette, FaEye } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Eye Hospital Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional eye hospital promotional videos, marketing posters & business materials. Download ready-made templates for eye hospitals, ophthalmology clinics, eye care services. Boost eye hospital business with MarketBrand.ai",
  keywords: "eye hospital marketing, ophthalmology marketing, eye care promotional videos, eye hospital templates, vision care marketing",
  alternates: { canonical: "/category/eye-hospital" },
  openGraph: {
    title: "Eye Hospital Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional eye hospital promotional videos, marketing posters & business materials. Download ready-made templates for eye hospitals, ophthalmology clinics, eye care services.",
    url: "https://www.marketbrand.ai/category/eye-hospital",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-eye-hospital.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
    ...
    title: "Eye Hospital Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional eye hospital promotional videos, marketing posters & business materials. Download ready-made templates for eye hospitals, ophthalmology clinics, eye care services.",
    images: ["/og-eye-hospital.jpg"],
  },
};

export default function EyeHospitalPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Eye Hospital Marketing Materials & Promotional Content",
    "description": "Professional eye hospital promotional videos, marketing posters & business materials for eye hospital professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited eye hospital marketing materials"
    },
    "category": "Eye Hospital Marketing Services"
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Eye Hospital</span>
            </nav>
          </div>
        </div>

        {/* Enhanced Hero Section */}
        <div className="relative py-16 overflow-hidden bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-rose-500/20">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="flex flex-row gap-1 sm:gap-1.5 justify-center lg:justify-end lg:items-center w-full lg:w-auto">
                ...
                <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-md px-2 sm:px-2.5 py-1.5 backdrop-blur-sm hover:scale-105 transition-all duration-300 flex items-center justify-center min-h-[28px] sm:min-h-[32px]">
                  <span className="text-purple-300 text-xs sm:text-sm font-semibold flex items-center gap-1 whitespace-nowrap"><BsStarFill className="text-xs" /> 4.9/5</span>
                </div>
                <div className="bg-gradient-to-r from-pink-500/20 to-rose-500/20 border border-pink-500/30 rounded-md px-2 sm:px-2.5 py-1.5 backdrop-blur-sm hover:scale-105 transition-all duration-300 flex items-center justify-center min-h-[28px] sm:min-h-[32px]">
                  <span className="text-pink-300 text-xs sm:text-sm font-semibold flex items-center gap-1 whitespace-nowrap"><FaRocket className="text-xs" /> Instant</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative mt-0">
              <HorizontalImageCarousel 
                images={[
                  "/Medical & Diagnostics/Eye Hospital/1.png",
                  "/Medical & Diagnostics/Eye Hospital/2.png",
                  "/Medical & Diagnostics/Eye Hospital/3.png",
                  "/Medical & Diagnostics/Eye Hospital/4.png",
                  "/Medical & Diagnostics/Eye Hospital/5.png"
                ]}
                interval={2000}
              />
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="card-premium text-center space-y-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  No design skills needed. Simply add your hospital details and customize colors to match your brand.
                </p>
              </div>

              <div className="card-premium text-center space-y-6">
                <div className="w-20 h-20 bg-gradient-to-r from-rose-500 to-purple-500 rounded-2xl flex items-center justify-center mx-auto text-3xl">
                  💼
                </div>
        ...
        {/* Final CTA Section */}
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-rose-500/20 relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 lg:px-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center">
              <Link 
                href="/download"
                className="inline-flex items-center justify-center px-6 sm:px-8 md:px-12 py-4 sm:py-5 md:py-6 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl sm:rounded-2xl text-white font-bold text-lg sm:text-xl md:text-2xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
