...
import { FaRocket, FaBolt, FaPalette, FaCalendar } from "react-icons/fa";
import { BsStarFill } from "react-icons/bs";
import { getRelativeImagePaths } from "@/utils/imagePath";
import TabbedImageCarousel from "@/components/TabbedImageCarousel";

export const metadata: Metadata = {
  title: "Event Planner Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional event planner promotional videos, marketing posters & business materials. Download ready-made templates for Mandap, Sound, Generator, Decorator services. Boost event planning business with MarketBrand.ai",
  keywords: "event planner marketing materials, event planning promotional videos, event planner marketing, mandap marketing, sound system marketing, generator rental marketing, decorator marketing",
  alternates: { canonical: "/category/event-planner" },
  openGraph: {
    title: "Event Planner Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional event planner promotional videos, marketing posters & business materials. Download ready-made templates for Mandap, Sound, Generator, Decorator services.",
    url: "https://www.marketbrand.ai/category/event-planner",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-event-planner.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
    ...
    title: "Event Planner Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional event planner promotional videos, marketing posters & business materials. Download ready-made templates for Mandap, Sound, Generator, Decorator services.",
    images: ["/og-event-planner.jpg"],
  },
};

export default function EventPlannerPage() {
  const currentRoute = "/category/event-planner"; // Define current route for SSR path calculation

  // Pre-convert image paths for static export
  const processedTabs = [
    {
      name: "Mandap",
      images: getRelativeImagePaths([
  ...
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Event Planner Marketing Materials & Promotional Content",
    "description": "Professional event planner promotional videos, marketing posters & business materials for event planning professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited event planner marketing materials"
    },
    "category": "Event Planning Marketing Services"
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Event Planner</span>
            </nav>
          </div>
        </div>

        {/* Enhanced Hero Section */}
        <div className="relative py-16 overflow-hidden bg-gradient-to-br from-blue-500/20 via-indigo-500/20 to-purple-500/20">
          <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
            <div className="flex flex-col lg:flex-row items-start gap-6 sm:gap-8 lg:gap-12">
              ...
              <div className="flex flex-row gap-1 sm:gap-1.5 justify-center lg:justify-end lg:items-center w-full lg:w-auto mb-4 sm:mb-6 lg:mb-0">
        ...
        {/* Template Cards Gallery - REMOVED */}
        ...
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-pink-500/20 relative overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 lg:px-12 text-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black gradient-text mb-4 sm:mb-6">
              Create Event Planner Materials
            </h2>
