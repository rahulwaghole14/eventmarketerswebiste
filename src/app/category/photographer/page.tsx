...
import { FaRocket, FaBolt, FaPalette, FaCamera } from "react-icons/fa";
...
export const metadata: Metadata = {
  title: "Photographer Marketing Materials | Professional Promotional Videos & Posters | MarketBrand.ai",
  description: "Professional photographer promotional videos, marketing posters & business materials. Download ready-made templates for wedding photographers, event photographers, portrait photographers. Boost photography business with MarketBrand.ai",
  keywords: "photographer marketing, photography promotional videos, wedding photographer marketing, event photographer marketing, photography service templates",
  alternates: { canonical: "/category/photographer" },
  openGraph: {
    title: "Photographer Marketing Materials | Professional Promotional Videos & Posters",
    description: "Professional photographer promotional videos, marketing posters & business materials. Download ready-made templates for wedding photographers, event photographers, portrait photographers.",
    url: "https://www.marketbrand.ai/category/photographer",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-photographer.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
  twitter: {
...
export default function PhotographerPage() {
  const structuredData = {
    ...
    "@type": "Service",
    "name": "Photographer Marketing Materials & Promotional Content",
    "description": "Professional photographer promotional videos, marketing posters & business materials for photography professionals",
    "provider": {
      "@type": "Organization",
      "name": "MarketBrand.ai",
    ...
    "offers": {
      ...
      "price": "2000",
      "priceCurrency": "INR",
      "description": "Annual subscription for unlimited photographer marketing materials"
    },
    "category": "Photography Marketing Services"
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="bg-gray-800/50 border-b border-white/10">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
            <nav className="flex items-center space-x-2 text-xs sm:text-sm flex-wrap">
              ...
              <span className="text-gray-500">/</span>
              <span className="text-white font-semibold break-words">Photographer</span>
            </nav>
          </div>
        </div>
        ...
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="card-premium text-center space-y-6">
                <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-red-500 rounded-2xl flex items-center justify-center mx-auto">
              ...
              <div className="card-premium text-center space-y-6">
                <div className="w-20 h-20 bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto text-3xl">
                  💼
                </div>
        ...
        {/* Final CTA Section */}
        <div className="py-12 sm:py-16 md:py-20 lg:py-24 bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-red-500/20 relative overflow-hidden">
          <div className="absolute inset-0">
            ...
            <div className="absolute bottom-10 left-10 w-80 h-80 bg-gradient-to-r from-pink-500/10 to-red-500/10 rounded-full blur-3xl animate-float-slow"></div>
          </div>
