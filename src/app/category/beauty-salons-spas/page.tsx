  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="relative py-16 bg-gradient-to-br from-purple-500/20 via-pink-500/20 to-rose-500/20 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-8 lg:gap-12">
              ...
              <div className="flex flex-row lg:flex-col gap-2 justify-center lg:justify-start lg:sticky lg:top-24">
                <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-purple-300 text-xs font-semibold whitespace-nowrap">✓ Trusted by 3,200+ Beauty Professionals</span>
                </div>
                <div className="bg-gradient-to-r from-pink-500/20 to-rose-500/20 border border-pink-500/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-pink-300 text-xs font-semibold whitespace-nowrap">⭐ 4.8/5 Rating</span>
                </div>
                <div className="bg-gradient-to-r from-rose-500/20 to-pink-500/20 border border-rose-500/30 rounded-lg px-3 py-2 backdrop-blur-sm hover:scale-105 transition-all duration-300">
                  <span className="text-rose-300 text-xs font-semibold whitespace-nowrap">🚀 1-Minute Download</span>
                </div>
              </div>
            </div>
          </div>
