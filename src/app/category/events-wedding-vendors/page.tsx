  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="relative py-24 bg-gradient-to-br from-pink-500/20 via-purple-500/20 to-indigo-500/20 overflow-hidden">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full px-4 py-2">
                  <span className="text-green-300 text-sm font-semibold">✓ Trusted by 5,000+ Wedding Vendors</span>
                </div>
              ...
              <div className="w-24 h-24 bg-gradient-to-r from-pink-500 to-purple-500 rounded-3xl flex items-center justify-center mx-auto mb-8 text-5xl shadow-2xl animate-pulse">
                💒
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Wedding Vendors</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-400 text-sm">Wedding Templates</div>
                </div>
                <div className="text-center">
