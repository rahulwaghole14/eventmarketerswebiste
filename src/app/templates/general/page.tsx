...
import { FaRocket, FaPalette, FaBolt, FaMobileAlt, FaSync, FaDownload } from "react-icons/fa";

export const metadata: Metadata = {
  title: "General Templates | Versatile Marketing Templates for Any Occasion | MarketBrand.ai",
  description: "Browse 200+ versatile general templates for social media, events, announcements, and more. Professional designs for any occasion with instant download.",
  keywords: "general templates, versatile templates, social media templates, event templates, announcement templates, general marketing materials",
  alternates: { canonical: "/templates/general" },
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  openGraph: {
    title: "General Templates | Versatile Marketing Templates | MarketBrand.ai",
    description: "Browse 200+ versatile general templates. Instant download, easy customization.",
    url: "https://www.marketbrand.ai/templates/general",
    siteName: "MarketBrand.ai",
    images: [{ url: "/og-templates-general.jpg", width: 1200, height: 630 }],
    locale: "en_IN",
    type: "website",
  },
};
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900">
        {/* Hero Section */}
        <div className="relative py-24 bg-gradient-to-br from-green-500/20 via-teal-500/20 to-cyan-500/20 overflow-hidden">
            ...
            <div className="text-center">
              <div className="flex flex-wrap justify-center items-center gap-4 mb-8">
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full px-4 py-2">
                  <span className="text-green-300 text-sm font-semibold">✓ 200+ Templates</span>
                </div>
              ...
              <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-teal-500 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl">
              ...
              <p className="text-xl text-gray-300 font-light max-w-4xl mx-auto mb-12 leading-relaxed">
                Versatile templates for any occasion. Create stunning social media posts, event invitations, announcements, and more.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  href="/download"
                  className="inline-flex items-center px-10 py-5 bg-gradient-to-r from-green-500 to-teal-500 rounded-2xl text-white font-bold text-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
          ...
          <div className="mx-auto max-w-7xl px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-black gradient-text mb-4">
                Popular General Template Types
              </h2>
        ...
        <div className="py-24 bg-gradient-to-b from-gray-800 to-gray-900">
          <div className="mx-auto max-w-7xl px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-black gradient-text mb-4">
                Why Choose Our General Templates?
              </h2>
            </div>
        ...
        {/* CTA Section */}
        <div className="py-24 bg-gradient-to-r from-green-500/20 via-teal-500/20 to-cyan-500/20 relative overflow-hidden">
          <div className="absolute inset-0">
          ...
          <div className="relative z-10 mx-auto max-w-6xl px-4 text-center">
            <h2 className="text-5xl lg:text-6xl font-black gradient-text mb-6">
              Ready to Create Versatile Marketing Materials?
            </h2>
            <p className="text-2xl text-gray-300 font-light max-w-4xl mx-auto mb-12 leading-relaxed">
              Join 50,000+ businesses already using MarketBrand to create stunning marketing materials for any occasion
            </p>
            ...
            <p className="text-gray-400 text-lg mt-8 flex items-center gap-2 justify-center">
              <FaBolt className="inline" /> Join 50,000+ Businesses • 200+ General Templates • 1-Minute Creation
            </p>
          </div>
        </div>
      </div>
