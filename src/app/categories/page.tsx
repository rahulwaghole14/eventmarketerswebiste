...
export default function CategoriesPage() {
  ...
  // Returns relative path for static export compatibility
  const getCategoryImage = (slug: string): string => {
    ...
    const absolutePath = imageMap[slug] || "/hero-image.png";
    // Convert to relative path for static export (from /categories route)
    return getRelativeImagePath(absolutePath, "/categories");
  };
                    ...
                    >
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        ...
                        <div className="relative w-full bg-gray-800 flex items-center justify-center overflow-hidden flex-1 min-h-0">
                          <img
                            src={encodeURI(getCategoryImage(category.slug).replace(/&/g, '%26'))}
                            alt={category.title}
